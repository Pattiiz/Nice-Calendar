<%-- 
    Document   : loginerror
    Created on : Apr 12, 2017, 11:05:04 PM
    Author     : Plaster
--%>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <% String rq = (String) request.getParameter("result");
                            String rq2 = (String) request.getParameter("user"); %>
                        <% if (rq.equals("wpass")) {%>
                        <p style="color: red;">Password isn't correct</p>
                        <% } %>
                        <% if (rq.equals("nouser")) {%>
                        ...
                        <form action="login.process" method="POST">
                            <div class="form-group">
                                ...
                                <% if (rq.equals("wpass")) {%>
                                <input type="text" class="form-control" id="usr" name="username" value="<% out.println(rq2); %>">
                                <% } else {%>
